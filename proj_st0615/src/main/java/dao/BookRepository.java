...
public class BookRepository {
	...
	public BookRepository() {
        ...
        book1.setDescription(
            "이 책은 자바 프로그래밍의 기초 문법부터 객체 지향 개념까지 초보자의 눈높이에 맞추어 친절하게 설명합니다.\n" +
        ...
        book2.setDescription(
            "최신 스프링 부트 프레임워크를 활용하여 안정적이고 확장성 높은 웹 애플리케이션을 구축하는 실전 가이드입니다.\n" +
        ...
        book3.setDescription(
            "효율적인 프로그램 작성을 위한 핵심 알고리즘과 기본 구조(스택, 큐, 트리 등)를 깊이 있게 분석합니다.\n" +
